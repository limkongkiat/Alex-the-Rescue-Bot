/* g++ tls-alex-client-termios.cpp make_tls_client.cpp tls_client_lib.cpp tls_pthread.cpp tls_common_lib.cpp -pthread -lssl -lcrypto -lncurses -o tls-alex-client-termios */
...
{
    // Initialize TLS communication with the Arduino Mega
    struct termios newt;
